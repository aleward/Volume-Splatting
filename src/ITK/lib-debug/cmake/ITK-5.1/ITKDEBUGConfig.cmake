...
get_filename_component(ITK_INSTALL_PREFIX "${ITK_INSTALL_PREFIX}" PATH)
get_filename_component(ITK_INSTALL_PREFIX "${ITK_INSTALL_PREFIX}" PATH)
set(ITKDEBUG_MODULES_DIR "${ITK_INSTALL_PREFIX}/lib-debug/cmake/ITK-5.1/Modules")

# The C and C++ flags added by ITK to the cmake-configured flags. TODO might not need to change
set(ITKDEBUG_REQUIRED_C_FLAGS "")
set(ITKDEBUG_REQUIRED_CXX_FLAGS " /bigobj")
set(ITKDEBUG_REQUIRED_LINK_FLAGS "")

# The ITK version number TODO check
...
# ITK's CMake directory with modules ITK uses. TODO check
set(ITKDEBUG_CMAKE_DIR "${ITK_INSTALL_PREFIX}/lib-debug/cmake/ITK-5.1")

# The location of the UseITK.cmake file.
set(ITK_DEBUG_USE_FILE "${ITK_INSTALL_PREFIX}/lib-debug/cmake/ITK-5.1/UseITK.cmake")
...
set(ITKDEBUG_FFTW_LIBDIR "${ITK_INSTALL_PREFIX}/lib-debug/ITK-5.1")

# Add FFTW include and library directories
if (ITK_USE_FFTWF OR ITK_USE_FFTWD)
  set(ITK_DEBUG_INCLUDE_DIRS ${ITK_DEBUG_INCLUDE_DIRS} "${ITK_FFTW_INCLUDE_PATH}")
  set(ITK_DEBUG_LIBRARY_DIRS ${ITK_DEBUG_LIBRARY_DIRS} "${ITKDEBUG_FFTW_LIBDIR}")
endif()

# Add configuration with GPU TODO see what this does
set(ITK_USE_GPU "OFF")
